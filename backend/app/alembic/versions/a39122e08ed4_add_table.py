...
Revision ID: a39122e08ed4
Revises: 
Create Date: 2024-12-09 23:45:15.192257
...
def upgrade():
    ...
    sa.Column('category', sqlmodel.sql.sqltypes.AutoString(length=25), nullable=False),
